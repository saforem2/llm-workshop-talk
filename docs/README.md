...
# [ `model.py`](https://github.com/saforem2/wordplay/blob/master/src/wordplay/model.py)
...
# [ `trainer.py`](https://github.com/saforem2/wordplay/blob/master/src/wordplay/trainer.py)
...
- <span style="background-color:#f8f8f8; padding: 2pt; border-radius: 6pt">📊
  [Slides](https://saforem2.github.io/llm-workshop-talk/#/llm-workshop-talk)</span>
- <span style="background-color:#f8f8f8; padding: 2pt; border-radius: 6pt">🏡
  [Project Website](https://saforem2.github.io/wordplay)</span>
- <span style="background-color:#f8f8f8; padding: 2pt; border-radius: 6pt">💻
  [`saforem2/wordplay`](https://github.com/saforem2/wordplay)</span>
