...
- [{{< iconify line-md github-loop >}}`argonne-lcf/llm-workshop`](https://github.com/brettin/llm_tutorial)
- [{{< iconify line-md github-loop >}}`saforem2/`](https://github.com/saforem2)
  - [{{< iconify line-md github-loop >}}`wordplay`](https://saforem2.github.io/wordplay) (GitHub)
  - [{{< bi easel >}} `llm-workshop-talk`](https://saforem2.github.io/LLM-tutorial) (slides)
...
# [{{< iconify fa-brands github >}} `model.py`](https://github.com/saforem2/wordplay/blob/master/src/wordplay/model.py) {height="100%"}
...
# [{{< iconify fa-brands github >}} `trainer.py`](https://github.com/saforem2/wordplay/blob/master/src/wordplay/trainer.py) {height="100%"}
...
- [Web Version](https://saforem2.github.io/wordplay/quarto/shakespeare.html)
